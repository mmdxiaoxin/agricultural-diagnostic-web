...
export type DetectImageProps = Omit<ImageProps, "src"> & {
	src: string;
	predictions: Prediction[];
};

const DetectImage: React.FC<DetectImageProps> = ({ src: imageUrl, predictions, ...props }) => {
	...
	return <Image src={processedImageUrl || imageUrl} {...props} />;
};
